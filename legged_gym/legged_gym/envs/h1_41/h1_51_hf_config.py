...
# 也许可以把torso固定了
# EnvCfg
class H1_51_HF_RoughCfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/h1_description/urdf/h1_with_hand_wrist.urdf'
        # file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/h1_description/urdf/h1_with_hand.urdf'
        name = "h1_2"
...
# RunnerCfg
class H1_51_HF_RoughCfgPPO(LeggedRobotCfgPPO):
    class policy:
        init_noise_std = 0.8
